...
export default function ImageTrail({
  ...
  return (
    ...
    >
      {items.map((url, i) => (
        <div
          className={`content__img ${imageSize} aspect-[1.1] rounded-[15px] absolute top-0 left-0 opacity-0 overflow-hidden [will-change:transform,filter]`}
          key={i}
        >
          <div
            className="content__img-inner bg-center bg-cover w-full h-full absolute top-0 left-0"
